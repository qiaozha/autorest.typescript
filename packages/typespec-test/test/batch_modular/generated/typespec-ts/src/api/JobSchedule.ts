...
async function _jobScheduleExistsSend(
  context: Client,
...
async function _jobScheduleExistsDeserialize(
  result: OperationRawReturnType<typeof _jobScheduleExistsSend>
): Promise<void> {
...
async function _deleteJobScheduleSend(
  context: Client,
  jobScheduleId: string,
...
async function _deleteJobScheduleDeserialize(
  result: OperationRawReturnType<typeof _deleteJobScheduleSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
async function _getJobScheduleSend(
  context: Client,
  jobScheduleId: string,
...
async function _getJobScheduleDeserialize(
  result: OperationRawReturnType<typeof _getJobScheduleSend>
...
async function _patchJobScheduleSend(
  context: Client,
  jobScheduleId: string,
...
async function _patchJobScheduleDeserialize(
  result: OperationRawReturnType<typeof _patchJobScheduleSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function patchJobSchedule(
  ...
  const result = await _patchJobScheduleSend(context, jobScheduleId, options);
  return _patchJobScheduleDeserialize(result);
}
...
async function _updateJobScheduleSend(
  context: Client,
  jobScheduleId: string,
...
async function _updateJobScheduleDeserialize(
  result: OperationRawReturnType<typeof _updateJobScheduleSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function updateJobSchedule(
  ...
  const result = await _updateJobScheduleSend(context, jobScheduleId, options);
...
async function _disableJobScheduleSend(
  context: Client,
  jobScheduleId: string,
...
async function _disableJobScheduleDeserialize(
  result: OperationRawReturnType<typeof _disableJobScheduleSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
async function _enableJobScheduleSend(
  context: Client,
  jobScheduleId: string,
...
async function _enableJobScheduleDeserialize(
  result: OperationRawReturnType<typeof _enableJobScheduleSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
async function _terminateJobScheduleSend(
  context: Client,
  jobScheduleId: string,
...
async function _terminateJobScheduleDeserialize(
  result: OperationRawReturnType<typeof _terminateJobScheduleSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
async function _addJobScheduleSend(
  context: Client,
...
async function _addJobScheduleDeserialize(
  result: OperationRawReturnType<typeof _addJobScheduleSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function addJobSchedule(
  ...
  const result = await _addJobScheduleSend(context, options);
  return _addJobScheduleDeserialize(result);
}
...
async function _listJobSchedulesSend(
  context: Client,
...
async function _listJobSchedulesDeserialize(
  result: OperationRawReturnType<typeof _listJobSchedulesSend>
