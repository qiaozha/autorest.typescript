...
async function _listSupportedImagesSend(
  context: Client,
...
async function _listSupportedImagesDeserialize(
  result: OperationRawReturnType<typeof _listSupportedImagesSend>
...
async function _listPoolNodeCountsSend(
  context: Client,
...
async function _listPoolNodeCountsDeserialize(
  result: OperationRawReturnType<typeof _listPoolNodeCountsSend>
