...
async function _getAllJobLifetimeStatisticsSend(
  context: Client,
...
async function _getAllJobLifetimeStatisticsDeserialize(
  result: OperationRawReturnType<typeof _getAllJobLifetimeStatisticsSend>
...
export async function getAllJobLifetimeStatistics(
  ...
  const result = await _getAllJobLifetimeStatisticsSend(context, options);
  return _getAllJobLifetimeStatisticsDeserialize(result);
}
...
async function _deleteJobDeserialize(
  result: OperationRawReturnType<typeof _deleteJobSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
async function _getJobDeserialize(
  result: OperationRawReturnType<typeof _getJobSend>
): Promise<BatchJob> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
async function _patchJobDeserialize(
  result: OperationRawReturnType<typeof _patchJobSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function patchJob(
  ...
  const result = await _patchJobSend(context, jobId, options);
  return _patchJobDeserialize(result);
}
...
async function _updateJobDeserialize(
  result: OperationRawReturnType<typeof _updateJobSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function updateJob(
  ...
  const result = await _updateJobSend(context, jobId, options);
...
async function _disableJobSend(
  context: Client,
...
async function _disableJobDeserialize(
  result: OperationRawReturnType<typeof _disableJobSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function disableJob(
  ...
  const result = await _disableJobSend(context, disableTasks, jobId, options);
...
async function _enableJobDeserialize(
  result: OperationRawReturnType<typeof _enableJobSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
async function _terminateJobSend(
  context: Client,
  jobId: string,
...
async function _terminateJobDeserialize(
  result: OperationRawReturnType<typeof _terminateJobSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
async function _addJobDeserialize(
  result: OperationRawReturnType<typeof _addJobSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function addJob(
  ...
  const result = await _addJobSend(context, options);
  return _addJobDeserialize(result);
}
...
async function _listJobsDeserialize(
  result: OperationRawReturnType<typeof _listJobsSend>
...
async function _listFromJobScheduleSend(
  context: Client,
...
async function _listFromJobScheduleDeserialize(
  result: OperationRawReturnType<typeof _listFromJobScheduleSend>
): Promise<BatchJobListResult> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function listFromJobSchedule(
  ...
  const result = await _listFromJobScheduleSend(
    context,
    jobScheduleId,
    options
  );
  return _listFromJobScheduleDeserialize(result);
}
...
async function _listPreparationAndReleaseTaskStatusSend(
  context: Client,
  jobId: string,
...
async function _listPreparationAndReleaseTaskStatusDeserialize(
  result: OperationRawReturnType<
    typeof _listPreparationAndReleaseTaskStatusSend
  >
...
export async function listPreparationAndReleaseTaskStatus(
  ...
  const result = await _listPreparationAndReleaseTaskStatusSend(
    context,
    jobId,
    options
  );
  return _listPreparationAndReleaseTaskStatusDeserialize(result);
}
...
async function _getTaskCountsSend(
  context: Client,
  jobId: string,
...
async function _getTaskCountsDeserialize(
  result: OperationRawReturnType<typeof _getTaskCountsSend>
...
export async function getTaskCounts(
  ...
  const result = await _getTaskCountsSend(context, jobId, options);
  return _getTaskCountsDeserialize(result);
}
