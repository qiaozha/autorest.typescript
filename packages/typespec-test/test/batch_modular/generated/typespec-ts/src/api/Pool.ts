...
async function _listUsageMetricsSend(
  context: Client,
...
async function _listUsageMetricsDeserialize(
  result: OperationRawReturnType<typeof _listUsageMetricsSend>
): Promise<CustomPage> {
...
export async function listUsageMetrics(
  ...
  const result = await _listUsageMetricsSend(context, options);
  return _listUsageMetricsDeserialize(result);
}
...
async function _getAllPoolLifetimeStatisticsSend(
  context: Client,
...
async function _getAllPoolLifetimeStatisticsDeserialize(
  result: OperationRawReturnType<typeof _getAllPoolLifetimeStatisticsSend>
...
export async function getAllPoolLifetimeStatistics(
  ...
  const result = await _getAllPoolLifetimeStatisticsSend(context, options);
  return _getAllPoolLifetimeStatisticsDeserialize(result);
}
...
async function _addPoolDeserialize(
  result: OperationRawReturnType<typeof _addPoolSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function addPool(
  ...
  const result = await _addPoolSend(context, options);
  return _addPoolDeserialize(result);
}
...
async function _listPoolsDeserialize(
  result: OperationRawReturnType<typeof _listPoolsSend>
...
async function _deletePoolSend(
  context: Client,
  poolId: string,
...
async function _deletePoolDeserialize(
  result: OperationRawReturnType<typeof _deletePoolSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
async function _existsDeserialize(
  result: OperationRawReturnType<typeof _existsSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function exists(
  ...
  const result = await _existsSend(context, poolId, options);
  return _existsDeserialize(result);
}
...
async function _getPoolDeserialize(
  result: OperationRawReturnType<typeof _getPoolSend>
): Promise<BatchPool> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
async function _patchPoolDeserialize(
  result: OperationRawReturnType<typeof _patchPoolSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function patchPool(
  ...
  const result = await _patchPoolSend(context, poolId, options);
  return _patchPoolDeserialize(result);
}
...
async function _disableAutoScaleSend(
  context: Client,
  poolId: string,
...
async function _disableAutoScaleDeserialize(
  result: OperationRawReturnType<typeof _disableAutoScaleSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function disableAutoScale(
  ...
  const result = await _disableAutoScaleSend(context, poolId, options);
...
async function _enableAutoScaleSend(
  context: Client,
  poolId: string,
...
async function _enableAutoScaleDeserialize(
  result: OperationRawReturnType<typeof _enableAutoScaleSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function enableAutoScale(
  ...
  const result = await _enableAutoScaleSend(context, poolId, options);
  return _enableAutoScaleDeserialize(result);
}
...
async function _evaluateAutoScaleSend(
  context: Client,
  autoScaleFormula: string,
  poolId: string,
...
async function _evaluateAutoScaleDeserialize(
  result: OperationRawReturnType<typeof _evaluateAutoScaleSend>
...
export async function evaluateAutoScale(
  ...
  const result = await _evaluateAutoScaleSend(
    context,
    autoScaleFormula,
    poolId,
    options
  );
  return _evaluateAutoScaleDeserialize(result);
}
...
async function _resizeDeserialize(
  result: OperationRawReturnType<typeof _resizeSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function resize(
  ...
  const result = await _resizeSend(context, poolId, options);
...
async function _stopResizeSend(
  context: Client,
  poolId: string,
...
async function _stopResizeDeserialize(
  result: OperationRawReturnType<typeof _stopResizeSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function stopResize(
  ...
  const result = await _stopResizeSend(context, poolId, options);
...
async function _updatePropertiesSend(
  context: Client,
  poolId: string,
...
async function _updatePropertiesDeserialize(
  result: OperationRawReturnType<typeof _updatePropertiesSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function updateProperties(
  ...
  const result = await _updatePropertiesSend(context, poolId, options);
  return _updatePropertiesDeserialize(result);
}
...
async function _removeNodesSend(
  context: Client,
  nodeList: string[],
  poolId: string,
...
async function _removeNodesDeserialize(
  result: OperationRawReturnType<typeof _removeNodesSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function removeNodes(
  ...
  const result = await _removeNodesSend(context, nodeList, poolId, options);
