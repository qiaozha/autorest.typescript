...
async function _getComputeNodeExtensionsSend(
  context: Client,
  poolId: string,
  nodeId: string,
...
async function _getComputeNodeExtensionsDeserialize(
  result: OperationRawReturnType<typeof _getComputeNodeExtensionsSend>
...
export async function getComputeNodeExtensions(
  ...
  const result = await _getComputeNodeExtensionsSend(
    context,
    poolId,
    nodeId,
    extensionName,
  ...
  return _getComputeNodeExtensionsDeserialize(result);
}
...
async function _listComputeNodeExtensionsSend(
  context: Client,
  poolId: string,
  nodeId: string,
...
async function _listComputeNodeExtensionsDeserialize(
  result: OperationRawReturnType<typeof _listComputeNodeExtensionsSend>
...
export async function listComputeNodeExtensions(
  ...
  const result = await _listComputeNodeExtensionsSend(
    context,
    poolId,
    nodeId,
    options
  );
  return _listComputeNodeExtensionsDeserialize(result);
}
