...
async function _addTaskDeserialize(
  result: OperationRawReturnType<typeof _addTaskSend>
): Promise<void> {
...
export async function addTask(
  ...
  const result = await _addTaskSend(context, jobId, options);
  return _addTaskDeserialize(result);
}
...
async function _listTasksDeserialize(
  result: OperationRawReturnType<typeof _listTasksSend>
...
async function _addTaskCollectionSend(
  context: Client,
  value: BatchTask[],
  jobId: string,
...
async function _addTaskCollectionDeserialize(
  result: OperationRawReturnType<typeof _addTaskCollectionSend>
...
export async function addTaskCollection(
  ...
  const result = await _addTaskCollectionSend(context, value, jobId, options);
  return _addTaskCollectionDeserialize(result);
}
...
async function _deleteTaskCollectionSend(
  context: Client,
  jobId: string,
  taskId: string,
...
async function _deleteTaskCollectionDeserialize(
  result: OperationRawReturnType<typeof _deleteTaskCollectionSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function deleteTaskCollection(
  ...
  const result = await _deleteTaskCollectionSend(
    context,
    jobId,
    taskId,
    options
  );
  return _deleteTaskCollectionDeserialize(result);
}
...
async function _getTaskCollectionSend(
  context: Client,
  jobId: string,
  taskId: string,
...
async function _getTaskCollectionDeserialize(
  result: OperationRawReturnType<typeof _getTaskCollectionSend>
): Promise<BatchTask> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function getTaskCollection(
  ...
  const result = await _getTaskCollectionSend(context, jobId, taskId, options);
  return _getTaskCollectionDeserialize(result);
}
...
async function _updateTaskCollectionSend(
  context: Client,
  jobId: string,
  taskId: string,
...
async function _updateTaskCollectionDeserialize(
  result: OperationRawReturnType<typeof _updateTaskCollectionSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function updateTaskCollection(
  ...
  const result = await _updateTaskCollectionSend(
    context,
    jobId,
    taskId,
    options
  );
  return _updateTaskCollectionDeserialize(result);
}
...
async function _listSubtasksSend(
  context: Client,
  jobId: string,
  taskId: string,
...
async function _listSubtasksDeserialize(
  result: OperationRawReturnType<typeof _listSubtasksSend>
...
async function _terminateTaskCollectionSend(
  context: Client,
  jobId: string,
  taskId: string,
...
async function _terminateTaskCollectionDeserialize(
  result: OperationRawReturnType<typeof _terminateTaskCollectionSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function terminateTaskCollection(
  ...
  const result = await _terminateTaskCollectionSend(
    context,
    jobId,
    taskId,
    options
  );
  return _terminateTaskCollectionDeserialize(result);
}
...
async function _reactivateTaskCollectionSend(
  context: Client,
  jobId: string,
  taskId: string,
...
async function _reactivateTaskCollectionDeserialize(
  result: OperationRawReturnType<typeof _reactivateTaskCollectionSend>
): Promise<void> {
  if (isUnexpected(result)) {
    throw result.body;
  }
...
export async function reactivateTaskCollection(
  ...
  const result = await _reactivateTaskCollectionSend(
    context,
    jobId,
    taskId,
    options
  );
  return _reactivateTaskCollectionDeserialize(result);
}
