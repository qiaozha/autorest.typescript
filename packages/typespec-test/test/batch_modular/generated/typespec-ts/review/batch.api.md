...
export class BatchServiceClient {
    ...
    computeNodes: {
        ...
        getRemoteDesktop: (poolId: string, nodeId: string, options?: ComputeNodesGetRemoteDesktopOptions) => Promise<any>;
    ...
    file: {
        ...
        getFromTask: (jobId: string, taskId: string, filePath: string, options?: FileGetFromTaskOptions) => Promise<any>;
        ...
        getFromComputeNode: (poolId: string, nodeId: string, filePath: string, options?: FileGetFromComputeNodeOptions) => Promise<any>;
