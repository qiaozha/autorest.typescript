...
export interface Routes {
  ...
  (path: "/paths/string/null/{enumPath}", enumPath: string): PathsEnumNull;
  ...
  (path: "/paths/byte/empty/{bytePath}", bytePath: string): PathsByteEmpty;
  ...
  (path: "/paths/date/2012-01-01/{datePath}", datePath: string): PathsDateValid;
  /** Resource for '/paths/date/null/\{datePath\}' has methods for the following verbs: get */
  (path: "/paths/date/null/{datePath}", datePath: string): PathsDateNull;
